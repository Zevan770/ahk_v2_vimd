...
class _Notepad {
    ...
    static getDoc(winTitle := "A") {
        ...
        if !vAddress {
            ...
            vAddress := 0
            loop {
                if !dllcall("kernel32\VirtualQueryEx", "ptr", hProc, "ptr", vAddress, "ptr", &MEMORY_BASIC_INFORMATION,
                    "uptr", (A_PtrSize = 8) ? 48 : 28, "uptr")
                    break
                ...
                dllcall("psapi\GetMappedFileName", "ptr", hProc, "ptr", vMbiBaseAddress, "str", vPath, "uint", MAX_PATH *
                    2, "uint")
                if !(vPath = "")
        ...
        dllcall("kernel32\ReadProcessMemory", "ptr", hProc, "ptr", vAddress, "str", vPath, "uptr", MAX_PATH * 2, "uptr",
            0)
