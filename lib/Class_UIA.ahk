...
class NativeArray {
    __new(ptr, count, type := "ptr") {
        ...
        static bits := { UInt: 4, UInt64: 8, Int: 4, Int64: 8, Short: 2, UShort: 2, Char: 1, UChar: 1, Double: 8, Float: 4,
            Ptr: A_PtrSize, UPtr: A_PtrSize }
        this.size := (this.count := count) * (bit := bits.%type%), this.ptr := ptr || dllcall("ole32\CoTaskMemAlloc",
            "uint", this.size, "ptr")
...
class UIA {
    static ptr := ComObjValue(this.__ := ComObject("{ff48dba4-60ef-4201-aa87-54103eef594e}",
        "{30cbe57d-d9d0-452a-ab13-7ac5ac4825ee}"))
    ; https://docs.microsoft.com/zh-cn/windows/win32/winauto/uiauto-controltype-ids
    static ControlType := { Button: 50000, Calendar: 50001, CheckBox: 50002, ComboBox: 50003, Edit: 50004, Hyperlink: 50005,
        Image: 50006, ListItem: 50007, List: 50008, Menu: 50009, MenuBar: 50010, MenuItem: 50011, ProgressBar: 50012,
        RadioButton: 50013, ScrollBar: 50014, Slider: 50015, Spinner: 50016, StatusBar: 50017, Tab: 50018, TabItem: 50019,
        Text: 50020, ToolBar: 50021, ToolTip: 50022, Tree: 50023, TreeItem: 50024, Custom: 50025, Group: 50026, Thumb: 50027,
        DataGrid: 50028, DataItem: 50029, Document: 50030, SplitButton: 50031, Window: 50032, Pane: 50033, Header: 50034,
        HeaderItem: 50035, Table: 50036, TitleBar: 50037, Separator: 50038, SemanticZoom: 50039, AppBar: 50040,
        50000: "Button", 50001: "Calendar", 50002: "CheckBox", 50003: "ComboBox", 50004: "Edit", 50005: "Hyperlink",
        50006: "Image", 50007: "ListItem", 50008: "List", 50009: "Menu", 50010: "MenuBar", 50011: "MenuItem", 50012: "ProgressBar",
        50013: "RadioButton", 50014: "ScrollBar", 50015: "Slider", 50016: "Spinner", 50017: "StatusBar", 50018: "Tab",
        50019: "TabItem", 50020: "Text", 50021: "ToolBar", 50022: "ToolTip", 50023: "Tree", 50024: "TreeItem", 50025: "Custom",
        50026: "Group", 50027: "Thumb", 50028: "DataGrid", 50029: "DataItem", 50030: "Document", 50031: "SplitButton",
        50032: "Window", 50033: "Pane", 50034: "Header", 50035: "HeaderItem", 50036: "Table", 50037: "TitleBar", 50038: "Separator",
        50039: "SemanticZoom", 50040: "AppBar" }
    static ControlPattern := { Invoke: 10000, Selection: 10001, Value: 10002, RangeValue: 10003, Scroll: 10004,
        ExpandCollapse: 10005, Grid: 10006, GridItem: 10007, MultipleView: 10008, Window: 10009, SelectionItem: 10010,
        Dock: 10011, Table: 10012, TableItem: 10013, Text: 10014, Toggle: 10015, Transform: 10016, ScrollItem: 10017,
        LegacyIAccessible: 10018, ItemContainer: 10019, VirtualizedItem: 10020, SynchronizedInput: 10021, ObjectModel: 10022,
        Annotation: 10023, Styles: 10025, Spreadsheet: 10026, SpreadsheetItem: 10027, TextChild: 10029, Drag: 10030,
        DropTarget: 10031, TextEdit: 10032, CustomNavigation: 10033,
        10000: "Invoke", 10001: "Selection", 10002: "Value", 10003: "RangeValue", 10004: "Scroll", 10005: "ExpandCollapse",
        10006: "Grid", 10007: "GridItem", 10008: "MultipleView", 10009: "Window", 10010: "SelectionItem", 10011: "Dock",
        10012: "Table", 10013: "TableItem", 10014: "Text", 10015: "Toggle", 10016: "Transform", 10017: "ScrollItem",
        10018: "LegacyIAccessible", 10019: "ItemContainer", 10020: "VirtualizedItem", 10021: "SynchronizedInput", 10022: "ObjectModel",
        10023: "Annotation", 10025: "Styles", 10026: "Spreadsheet", 10027: "SpreadsheetItem", 10029: "TextChild", 10030: "Drag",
        10031: "DropTarget", 10032: "TextEdit", 10033: "CustomNavigation" }
    static Event := { ToolTipOpened: 20000, ToolTipClosed: 20001, StructureChanged: 20002, MenuOpened: 20003,
        AutomationPropertyChanged: 20004, AutomationFocusChanged: 20005, AsyncContentLoaded: 20006, MenuClosed: 20007,
        LayoutInvalidated: 20008, Invoke_Invoked: 20009, SelectionItem_ElementAddedToSelection: 20010,
        SelectionItem_ElementRemovedFromSelection: 20011, SelectionItem_ElementSelected: 20012, Selection_Invalidated: 20013,
        Text_TextSelectionChanged: 20014, Text_TextChanged: 20015, Window_WindowOpened: 20016, Window_WindowClosed: 20017,
        MenuModeStart: 20018, MenuModeEnd: 20019, InputReachedTarget: 20020, InputReachedOtherElement: 20021,
        InputDiscarded: 20022, SystemAlert: 20023, LiveRegionChanged: 20024, HostedFragmentRootsInvalidated: 20025,
        Drag_DragStart: 20026, Drag_DragCancel: 20027, Drag_DragComplete: 20028, DropTarget_DragEnter: 20029,
        DropTarget_DragLeave: 20030, DropTarget_Dropped: 20031, TextEdit_TextChanged: 20032,
        TextEdit_ConversionTargetChanged: 20033, Changes: 20034, Notification: 20035, ActiveTextPositionChanged: 20036 }
    static Property := {
    ...
    static FindControl(ControlType := "", value := unset, field := "Name", flag := 0, ms := 0, scope := 4, checkBound :=
        false) {
        ...
        if (ControlType is array)
            ...
            return this.ElementFromHandle(hwnd, bIsWindow).FindControl(ControlType, value?, field, flag, ms, scope,
                checkBound)
    }
    ...
    static CompareRuntimeIds(runtimeId1, runtimeId2) => (comcall(4, this, "ptr", runtimeId1, "ptr", runtimeId2, "int*", &
        areSame := 0), areSame)
    ...
    */
    ...
    static GetRootElementBuildCache(cacheRequest) => (comcall(9, this, "ptr", cacheRequest, "ptr*", &root := 0),
    ...
    static ElementFromHandleBuildCache(hwnd, cacheRequest) => (comcall(10, this, "ptr", hwnd, "ptr", cacheRequest,
        "ptr*", &element := 0), IUIAutomationElement(element))
    ...
    static ElementFromPointBuildCache(pt, cacheRequest) => (comcall(11, this, "int64", pt, "ptr", cacheRequest, "ptr*", &
        element := 0), IUIAutomationElement(element))

    ; Retrieves the UI Automation element that has the input focus, prefetches the requested properties and control patterns, and stores the prefetched items in the cache.
    static GetFocusedElementBuildCache(cacheRequest) => (comcall(12, this, "ptr", cacheRequest, "ptr*", &element := 0),
    IUIAutomationElement(element))

    ; Retrieves a tree walker object that can be used to traverse the Microsoft UI Automation tree.
    static CreateTreeWalker(pCondition) => (comcall(13, this, "ptr", pCondition, "ptr*", &walker := 0),
    ...
    static CreateCacheRequest() => (comcall(20, this, "ptr*", &cacheRequest := 0), IUIAutomationCacheRequest(
        cacheRequest))
    ...
    static smartCondition(ControlType, value := unset, field := "Name", flag := 0) {
        ...
        if (!isset(value)) ;NOTE 单条件
            ...
            return UIA.CreateAndCondition(UIA.CreatePropertyCondition(30003, ControlType), UIA.CreatePropertyConditionEx(
                UIA.property.%field%, value, flag))
        else
            return UIA.CreateAndCondition(UIA.CreatePropertyCondition(30003, ControlType), UIA.CreatePropertyCondition(
                UIA.property.%field%, value))
    }

    ; Retrieves a predefined condition that selects all elements.
    static CreateTrueCondition() => (comcall(21, this, "ptr*", &newCondition := 0), IUIAutomationBoolCondition(
        newCondition))
    ...
    static CreateFalseCondition() => (comcall(22, this, "ptr*", &newCondition := 0), IUIAutomationBoolCondition(
        newCondition))
    ...
    static CreatePropertyCondition(propertyId, value) {
        ...
        if (A_PtrSize == 4) {
            v := ComVar(value, , true)
            comcall(23, this, "int", propertyId, "int64", numget(v, 0, "int64"), "int64", numget(v, 8, "int64"), "ptr*", &
            newCondition := 0)
        } else {
    ...
    static CreatePropertyConditionEx(propertyId, value, flags := 2) {
        ...
        if (A_PtrSize == 4) {
            v := ComVar(value)
            comcall(24, this, "int", propertyId, "int64", numget(v, 0, "int64"), "int64", numget(v, 8, "int64"), "int",
            flags, "ptr*", &newCondition := 0)
        } else {
    ...
    static CreateAndCondition(condition1, condition2) => (comcall(25, this, "ptr", condition1, "ptr", condition2,
        "ptr*", &newCondition := 0), IUIAutomationAndCondition(newCondition))
    ...
    static CreateAndConditionFromArray(conditions) => (comcall(26, this, "ptr", conditions, "ptr*", &newCondition := 0),
    IUIAutomationAndCondition(newCondition))

    ; Creates a condition that selects elements based on multiple conditions, all of which must be true.
    static CreateAndConditionFromNativeArray(conditions, conditionCount) => (comcall(27, this, "ptr", conditions, "int",
        conditionCount, "ptr*", &newCondition := 0), IUIAutomationAndCondition(newCondition))

    ; Creates a combination of two conditions where a match exists if either of the conditions is true.
    static CreateOrCondition(condition1, condition2) => (comcall(28, this, "ptr", condition1, "ptr", condition2, "ptr*", &
        newCondition := 0), IUIAutomationOrCondition(newCondition))

    ; Creates a combination of two or more conditions where a match exists if any of the conditions is true.
    static CreateOrConditionFromArray(conditions) => (comcall(29, this, "ptr", conditions, "ptr*", &newCondition := 0),
    IUIAutomationOrCondition(newCondition))

    ; Creates a combination of two or more conditions where a match exists if any one of the conditions is true.
    static CreateOrConditionFromNativeArray(conditions, conditionCount) => (comcall(30, this, "ptr", conditions, "ptr",
        conditionCount, "ptr*", &newCondition := 0), IUIAutomationOrCondition(newCondition))

    ; Creates a condition that is the negative of a specified condition.
    static CreateNotCondition(condition) => (comcall(31, this, "ptr", condition, "ptr*", &newCondition := 0),
    IUIAutomationNotCondition(newCondition))
    ...
    static AddAutomationEventHandler(eventId, element, scope, cacheRequest, handler) => comcall(32, this, "int",
        eventId, "ptr", element, "int", scope, "ptr", cacheRequest ? cacheRequest : 0, "ptr", handler)

    ; Removes the specified UI Automation event handler.
    static RemoveAutomationEventHandler(eventId, element, handler) => comcall(33, this, "int", eventId, "ptr", element,
        "ptr", handler)
    ...
    static AddPropertyChangedEventHandlerNativeArray(element, scope, cacheRequest, handler, propertyArray,
        propertyCount) => comcall(34, this, "ptr", element, "int", scope, "ptr", cacheRequest, "ptr", handler, "ptr",
            propertyArray, "int", propertyCount)

    ; Registers a method that handles property-changed events.
    ; The UI item specified by element might not support the properties specified by the propertyArray parameter.
    static AddPropertyChangedEventHandler(element, scope, cacheRequest, handler, propertyArray) => comcall(35, this,
        "ptr", element, "int", scope, "ptr", cacheRequest, "ptr", handler, "ptr", propertyArray)
    ...
    static AddStructureChangedEventHandler(element, scope, cacheRequest, handler) => comcall(37, this, "ptr", element,
        "int", scope, "ptr", cacheRequest ? cacheRequest : 0, "ptr", handler)
    ...
    static AddFocusChangedEventHandler(cacheRequest, handler) => comcall(39, this, "ptr", cacheRequest ? cacheRequest :
        0, "ptr", handler)
    ...
    static IntNativeArrayToSafeArray(array, arrayCount) => (comcall(42, this, "ptr", array, "int", arrayCount, "ptr*", &
        safeArray := 0), ComValue(0x2003, safeArray))

    ; Converts a SAFEARRAY of integers to an array.
    static IntSafeArrayToNativeArray(intArray) => (comcall(43, this, "ptr", intArray, "ptr*", &array := 0, "int*", &
        arrayCount := 0), NativeArray(array, arrayCount, "int"))
    ...
    static VariantToRect(var) {
        if (A_PtrSize == 4)
            comcall(45, this, "int64", numget(var, 0, "int64"), "int64", numget(var, 8, "int64"), "ptr", rc :=
            NativeArray(0, 4, "Int"))
        else
    ...
    static SafeArrayToRectNativeArray(rects) => (comcall(46, this, "ptr", rects, "ptr*", &rectArray := 0, "int*", &
        rectArrayCount := 0), NativeArray(rectArray, rectArrayCount, "int"))
    ...
    static CreateProxyFactoryEntry(factory) => (comcall(47, this, "ptr", factory, "ptr*", &factoryEntry := 0),
    ...
    static ProxyFactoryMapping() => (comcall(48, this, "ptr*", &factoryMapping := 0), IUIAutomationProxyFactoryMapping(
        factoryMapping))
    ...
    static CheckNotSupported(value) {
        if (A_PtrSize == 4)
            value := ComVar(value, , true), comcall(53, this, "int64", numget(value, 0, "int64"), "int64", numget(value,
                8, "int64"), "int*", &isNotSupported := 0)
        else
    ...
    static ReservedNotSupportedValue() => (comcall(54, this, "ptr*", &notSupportedValue := 0), ComValue(0xd,
        notSupportedValue))
    ...
    static ReservedMixedAttributeValue() => (comcall(55, this, "ptr*", &mixedAttributeValue := 0), ComValue(0xd,
        mixedAttributeValue))
    ...
    static ElementFromIAccessible(accessible, childId) => (comcall(56, this, "ptr", accessible, "int", childId, "ptr*", &
        element := 0), IUIAutomationElement(element))
    ...
    static ElementFromIAccessibleBuildCache(accessible, childId, cacheRequest) => (comcall(57, this, "ptr", accessible,
        "int", childId, "ptr", cacheRequest, "ptr*", &element := 0), IUIAutomationElement(element))
}

class IUIAutomationAndCondition extends IUIAutomationCondition {
    ChildCount => (comcall(3, this, "int*", &childCount := 0), childCount)
    GetChildrenAsNativeArray() => (comcall(4, this, "ptr*", &childArray := 0, "int*", &childArrayCount := 0),
    NativeArray(childArray, childArrayCount))
...
class IUIAutomationElement extends IUIABase {
    ...
    FindControls(arrParams) {
        ...
        OutputDebug(format("w#{1} {2}:{3} A_TickCount takes={4}", A_LineFile, A_LineNumber, A_ThisFunc, A_TickCount -
            timeSave))
        return arrEl
    }
    ...
    offsetOut(xOffset := 0, yOffset := 0, isOut := 1) {
        ...
        deal(v, x, w) {
            ...
            OutputDebug(format("i#{1} {2}:{3} v={4},x={5},w={6} isOut={7}, res={8}", A_LineFile, A_LineNumber,
                A_ThisFunc, v, x, w, isOut, res))
            return res
        }
    }
    ...
    FindByBeside(arrFind, arrOffset := 30, value := unset) {
        ...
        if (!elFocus)
            return
        if (isset(value)) {
            OutputDebug(format("i#{1} {2}:{3} ControlType={4} val={5}", A_LineFile, A_LineNumber, A_ThisFunc, elFocus.GetControlType(),
            elFocus.GetCurrentPropertyValue("ValueValue")))
        ...
        loop { ;没找到，需要往下滚动
            ...
            if (el is IUIAutomationElement) {
                if (el.GetBoundingRectangle()[2]) ;可能在页面底部看不清楚
                    break
                OutputDebug(format("i#{1} {2}:{3} A_Index={4} rect={5}", A_LineFile, A_LineNumber, A_ThisFunc, A_Index,
                    json.stringify(el.GetBoundingRectangle())))
            }
            if (A_Index == 1) { ;先回到最上方
    ...
    get(p*) {
        ...
        getTableData(p*) {
            ...
            OutputDebug(format("i#{1} {2}:{3} arrField={4}", A_LineFile, A_LineNumber, A_ThisFunc, json.stringify(
                arrField)))
            ;获取数据
    ...
    GetParentEx(bString := false) {
        ...
        loop (2) {
            ...
            if (aRect[4] > aRectThis[4] * 2) { ;找到父元素
                OutputDebug(format("d#{1} {2}: father={3} aRect={4}", A_LineFile, A_LineNumber, elParent.GetControlType(),
                json.stringify(aRect)))
                return elParent
            } else {
    ...
    getSiblingItems() {
        ...
        if (tpThis ~= "^(List|Tab)$") {
            ...
            tpSon := tpThis
            scope := 2
            OutputDebug(format("i#{1} {2}:elParent=GetParentEx tpSon={3} scope={4}", A_LineFile, A_LineNumber, tpSon,
                scope))
        }
        ...
        if (this.GetCurrentPropertyValue("ValueValue") != "") {
            ...
            funGetValue := (el) => el.FindFirst(UIA.CreatePropertyCondition("ControlType", tpSon)).GetCurrentPropertyValue(
                "ValueValue")
        }
        arr := []
        if (1) {
    ...
    do(p*) {
        ...
        switch this.CurrentControlType {
            case UIA.ControlType.Text:
                elParent := this.GetParent()
                OutputDebug(format("i#{1} {2}:{3} Text parent.CurrentControlType={4}", A_LineFile.fn(), A_LineNumber,
                A_ThisFunc, elParent.CurrentControlType))
            ...
            case UIA.ControlType.Tab: ;根据名称激活 TabItem
                ...
                if (name is integer) {
                    ...
                    for el in this.FindAll(UIA.CreateTrueCondition(), 2) {
                        OutputDebug(format("i#{1} {2}:{3} A_Index={4} A_Index,el.CurrentName={5}", A_LineFile,
                            A_LineNumber, A_ThisFunc, A_Index, el.CurrentName))
    ...
    allProperty(bDeleteNull := true) {
        ...
        ;obj["ControlType_Parent"] := this.GetParent().GetControlType()
        ;if (obj["ControlType"] == "ListItem")
        ;    obj["ZZ"] := this.getSiblingItems()
        obj["LocalizedControlType"] := this.CurrentLocalizedControlType
        obj["BoundingRectangle"] := format("xm:{1} ym:{2} r:{3} b:{4} [{5},{6},{7},{8}]", aRect[1] + aRect[3] // 2,
            aRect[2] + aRect[4] // 2, aRect[1] + aRect[3], aRect[2] + aRect[4], aRect*)
        ...
        if (obj["IsLegacyIAccessiblePatternAvailable"] := this.GetCurrentPropertyValue(
            "IsLegacyIAccessiblePatternAvailable")) {
            ...
            obj["LegacyIAccessibleKeyboardShortcut"] := this.GetCurrentPropertyValue(
        ...
        obj["IsSynchronizedInputPatternAvailable"] := this.GetCurrentPropertyValue(
            "IsSynchronizedInputPatternAvailable")
    ...
    see(bSec := 0) {
        ...
        tooltip(s, , , 9)
        if (bSec) {
            SetTimer(tooltip.bind(, , , 9), -(bSec * 1000))
        } else { ;
            ih := InputHook()
    ...
    selectByPath(arr, method := "") {
        ...
        for val in arr {
            ...
            cond := UIA.CreateAndCondition(UIA.CreatePropertyCondition("ControlType", "TreeItem"), UIA.CreatePropertyCondition(
                "Name", val))
    ...
    FindControlBuildCache(rst, ControlType, value, field := "Name", flag := 0, ms := 0) {
        if (ControlType is string) {
            if (ControlType == "") { ;NOTE 非 Control 比如obsidian的【警报】
                ...
                if (flag)
                    cond := UIA.CreateAndCondition(UIA.CreatePropertyCondition(30003, ControlType), UIA.CreatePropertyConditionEx(
                        UIA.property.%field%, value, flag))
                else
                    cond := UIA.CreateAndCondition(UIA.CreatePropertyCondition(30003, ControlType), UIA.CreatePropertyCondition(
                        UIA.property.%field%, value))
            }
        }
        endtime := A_TickCount + ms
    ...
    BuildUpdatedCache(cacheRequest) => (comcall(9, this, "ptr", cacheRequest, "ptr*", &updatedElement := 0),
    ...
    GetCurrentPropertyValueEx(propertyId, ignoreDefaultValue) => (comcall(11, this, "int", propertyId, "int",
        ignoreDefaultValue, "ptr", val := ComVar()), val[])
    ...
    GetCachedPropertyValueEx(propertyId, ignoreDefaultValue, retVal) => (comcall(13, this, "int", propertyId, "int",
        ignoreDefaultValue, "ptr", val := ComVar()), val[])
    ...
    CurrentBoundingRectangle => (comcall(43, this, "ptr", retVal := NativeArray(0, 4, "int")), { left: retVal[0], top: retVal[
        1], right: retVal[2], bottom: retVal[3] })
    ...
    CachedBoundingRectangle => (comcall(75, this, "ptr", retVal := NativeArray(0, 4, "int")), { left: retVal[0], top: retVal[
        1], right: retVal[2], bottom: retVal[3] })
    ...
    FindFirstWithOptions(condition, traversalOptions, root, scope := 4) {
        if (comcall(110, this, "int", scope, "ptr", condition, "int", traversalOptions, "ptr", root, "ptr*", &found :=
            0), found)
            return IUIAutomationElement(found)
        throw TargetError("Target element not found.")
    }
    FindAllWithOptions(condition, traversalOptions, root, scope := 4) {
        if (comcall(111, this, "int", scope, "ptr", condition, "int", traversalOptions, "ptr", root, "ptr*", &found :=
            0), found)
            return IUIAutomationElementArray(found)
        throw TargetError("Target elements not found.")
    }
    ...
    FindFirstWithOptionsBuildCache(condition, cacheRequest, traversalOptions, root, scope := 4) {
        if (comcall(112, this, "int", scope, "ptr", condition, "ptr", cacheRequest, "int", traversalOptions, "ptr",
            root, "ptr*", &found := 0), found)
            return IUIAutomationElement(found)
        throw TargetError("Target element not found.")
    }
    FindAllWithOptionsBuildCache(condition, cacheRequest, traversalOptions, root, scope := 4) {
        if (comcall(113, this, "int", scope, "ptr", condition, "ptr", cacheRequest, "int", traversalOptions, "ptr",
            root, "ptr*", &found := 0), found)
            return IUIAutomationElementArray(found)
        throw TargetError("Target elements not found.")
    }
    GetCurrentMetadataValue(targetId, metadataId) => (comcall(114, this, "int", targetId, "int", metadataId, "ptr",
        returnVal := ComVar()), returnVal[])
...
class IUIAutomationGridPattern extends IUIABase {
    ...
    GetItem(row, column) => (comcall(3, this, "int", row, "int", column, "ptr*", &element := 0),
    IUIAutomationGridItemPattern(element))
...
class IUIAutomationItemContainerPattern extends IUIABase {
    ...
    FindItemByProperty(pStartAfter, propertyId, value) {
        if (A_PtrSize == 4) {
            ...
            comcall(3, this, "ptr", pStartAfter, "int", propertyId, "int64", numget(value, 0, "int64"), "int64", numget(
                value, 8, "int64"), "ptr*", &pFound := 0)
        } else {
...
class IUIAutomationLegacyIAccessiblePattern extends IUIABase {
    ...
    GetCurrentSelection() => (comcall(14, this, "ptr*", &pvarSelectedChildren := 0), IUIAutomationElementArray(
    ...
    GetCachedSelection() => (comcall(24, this, "ptr*", &pvarSelectedChildren := 0), IUIAutomationElementArray(
        pvarSelectedChildren))
...
class IUIAutomationProxyFactory extends IUIABase {
    CreateProvider(hwnd, idObject, idChild) => (comcall(3, this, "ptr", hwnd, "int", idObject, "int", idChild, "ptr*", &
        provider := 0), ComValue(0xd, provider))
...
class IUIAutomationProxyFactoryEntry extends IUIABase {
    ...
    SetWinEventsForAutomationEvent(eventId, propertyId, winEvents) => comcall(14, this, "int", eventId, "Int",
        propertyId, "ptr", winEvents)
    GetWinEventsForAutomationEvent(eventId, propertyId) => (comcall(15, this, "int", eventId, "Int", propertyId, "ptr*", &
        winEvents := 0), ComValue(0x200d, winEvents))
}
...
class IUIAutomationScrollPattern extends IUIABase {
    ...
    SetScrollPercent(horizontalPercent, verticalPercent) => comcall(4, this, "double", horizontalPercent, "double",
        verticalPercent)
...
class IUIAutomationTextRange extends IUIABase {
    ...
    CompareEndpoints(srcEndPoint, range, targetEndPoint) => (comcall(5, this, "int", srcEndPoint, "ptr", range, "int",
        targetEndPoint, "int*", &compValue := 0), compValue)
    ...
    FindAttribute(attr, val, backward) {
        if (A_PtrSize == 4) {
            val := ComVar(val, , true)
            comcall(7, this, "int", attr, "int64", numget(val, 0, "int64"), "int64", numget(val, 8, "int64"), "int",
            backward, "ptr*", &found := 0)
        } else {
...
class IUIAutomationTreeWalker extends IUIABase {
    ...
    NormalizeElement(element) => (comcall(8, this, "ptr", element, "ptr*", &normalized := 0), IUIAutomationElement(
        normalized))

    ; Retrieves the parent element of the specified UI Automation element, and caches properties and control patterns.
    GetParentElementBuildCache(element, cacheRequest) => (comcall(9, this, "ptr", element, "ptr", cacheRequest, "ptr*", &
        parent := 0), IUIAutomationElement(parent))

    ; Retrieves the first child element of the specified UI Automation element, and caches properties and control patterns.
    GetFirstChildElementBuildCache(element, cacheRequest) => (comcall(10, this, "ptr", element, "ptr", cacheRequest,
        "ptr*", &first := 0), IUIAutomationElement(first))

    ; Retrieves the last child element of the specified UI Automation element, and caches properties and control patterns.
    GetLastChildElementBuildCache(element, cacheRequest) => (comcall(11, this, "ptr", element, "ptr", cacheRequest,
        "ptr*", &last := 0), IUIAutomationElement(last))

    ; Retrieves the next sibling element of the specified UI Automation element, and caches properties and control patterns.
    GetNextSiblingElementBuildCache(element, cacheRequest) => (comcall(12, this, "ptr", element, "ptr", cacheRequest,
        "ptr*", &next := 0), IUIAutomationElement(next))

    ; Retrieves the previous sibling element of the specified UI Automation element, and caches properties and control patterns.
    GetPreviousSiblingElementBuildCache(element, cacheRequest) => (comcall(13, this, "ptr", element, "ptr",
        cacheRequest, "ptr*", &previous := 0), IUIAutomationElement(previous))
    ...
    NormalizeElementBuildCache(element, cacheRequest) => (comcall(14, this, "ptr", element, "ptr", cacheRequest, "ptr*", &
        normalized := 0), IUIAutomationElement(normalized))
...
IUIA_EventHandler(funcobj) {
    ...
    EventHandler(self, param1 := 0, param2 := 0) {
        ...
        if (param1) {
            ...
            switch str, false {
                case "{00000000-0000-0000-C000-000000000046}", "{146c3c17-f12e-4e22-8c27-f894b9b79c69}",
                    "{40cd37d4-c756-4b0c-8c6f-bddfeeb13b50}", "{e81d1b4e-11c5-42f8-9754-e7036c79f054}",
                    "{c270f6b5-5c69-4290-9745-7a7f97169468}": return numput("ptr", self, param2) * 0
